      ...
      <div className="lg:flex justify-center">
        <div className="h-full w-full pb-16 px-4">
          <div className="flex flex-col items-center justify-center">
            <div className="bg-red-300 shadow-xl rounded-xl lg:w-2/3 md:w-1/2 w-full p-10 mt-16">
              <p
                tabIndex={0}
                aria-label="Login to your account"
                className="text-2xl font-extrabold leading-6 text-gray-800"
              >
                <span className="text-gray-100 text-3xl font-bold">Login</span>{" "}
              ...
              <p className="text-sm mt-4 font-medium leading-none text-gray-500">
                ...
                <Link
                  ...
                  className="text-sm font-medium leading-none underline text-gray-300 hover:text-red-500 cursor-pointer"
                >
                  {" "}
                  register here
                </Link>
              ...
              <form onSubmit={handleLoginFormSubmit} action="">
                ...
                <div>
                  ...
                  <input
                    ...
                    type="email"
                    className="bg-gray-200 border rounded-full focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"
                    required
                  />
                </div>
                ...
                <div className="mt-8">
                  <button
                    ...
                    className="focus:ring-2 focus:ring-offset-2 focus:ring-red-500 text-sm font-semibold leading-none text-white focus:outline-none bg-red-500 border rounded-full hover:bg-red-600 py-4 w-full"
                  >
                    Login
                  </button>
                </div>
